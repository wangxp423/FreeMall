 ...
 */
package com.aero.droid.dutyfree.talent.widgets.loading;
...
import com.aero.droid.dutyfree.talent.util.CommonUtils;
...
public class VaryViewHelperController {
    ...
    public void showEmpty(String emptyMsg, int emptyImgId, View.OnClickListener onClickListener) {
        View layout = helper.inflate(R.layout.message);
        TextView textView = (TextView) layout.findViewById(R.id.message_info);
    ...
    public void showLoading(String msg) {
        ...
        ImageView loadingImag = (ImageView) layout
                .findViewById(R.id.loadingImageView);
        AnimationDrawable animationDrawable = (AnimationDrawable) loadingImag
                .getBackground();
